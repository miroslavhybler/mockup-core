# mockup-core
Core dependency for Android Mockup Lib for version 2.x.x. See [ksp-mockup-processor repository](https://github.com/miroslavhybler/ksp-mockup-processor) for docs.
